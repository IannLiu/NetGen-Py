...
def load_data(args: PredictArgs, smiles: List[List[str]], features: List[List[float]] = None):
    """
    ...
    :param features: A list of list of features.
...
def make_predictions(
    ...
    :param features: List of list of features of SMILES.
    ...
    full_data, test_data, test_data_loader, full_to_valid_indices = load_data(args, smiles, features=features)
